...
import useFacilityAMCConfiguration from "../../../hooks/useFacilityAMCConfiguration";
...
const AMCTable = ({ t, facilityId }) => {
  ...
  const { isLoading, data: amcConfigurationData } = useFacilityAMCConfiguration(amcConfigurationQueryFilter, pageSize, pageOffset);
