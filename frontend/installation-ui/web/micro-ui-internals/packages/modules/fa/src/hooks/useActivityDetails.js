...
const fetchFacilityDetails = async (filter, limit, offset) => {
  ...
  return {
    ...
    activityDetails: {
      activityType: activityFacilityData?.activityFacility?.activityType,
      activityFacilityId: activityFacilityData?.activityFacility?.id,
    },
    auditTrail,
    assetAggregation,
    documentAggregation,
...
const useActivityDetails = (facilityAssignmentId) => {
