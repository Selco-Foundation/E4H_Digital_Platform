...
const NDSSCard = () => {
  ...
  const propsForModuleCard = {
    ...
    // subHeaderLink: `/${window.contextPath}/employee/payment/integration/dss/NURT_DASHBOARD`,
...
const DSSCard = () => {
  ...
  const propsForModuleCard = {
    ...
    // subHeaderLink: `/${window.contextPath}/employee/payment/integration/dss/home`,
