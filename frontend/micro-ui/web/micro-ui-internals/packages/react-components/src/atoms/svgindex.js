...
export const HomeIcon = ({ className, styles }) => (
  <svg className={className} viewBox="0 0 20 20" style={{ ...styles }}>
...
const PlayIcon = ({ color }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.2 122.88" width="24" height="24" fill={color}>
    <polygon points="92.2,60.97 0,122.88 0,0 92.2,60.97" />
  </svg>
);

const PauseIcon = ({ color }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 87.72 122.88" width="24" height="24" fill={color}>
