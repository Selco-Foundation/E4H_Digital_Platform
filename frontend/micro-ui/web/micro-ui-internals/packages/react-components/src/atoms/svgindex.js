...
const CreateEstimateIcon = ({ className, style = {}, fill = "#7a2829" }) => (
...
const GotoInboxIcon = ({ className, style = {}, fill = "#7a2829" }) => (
...
const CreateLoiIcon = ({ style, fill = "#7a2829" }) => (
...
const DeleteIconv2 = ({ styles, className, fill = "#7a2829", height = "24", width = "24" }) => (
  ...
  <svg width="336" height="262" viewBox="0 0 336 262" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_7426_33765)">
      ...
      <path
        ...
        fill="black"
      />
      <path d="M110.151 115.203L135.779 111.047V135.226L111.429 133.956L110.151 115.203Z" fill="#7a2829" />
      <path opacity="0.05" d="M110.151 115.203L135.779 111.047V135.226L111.429 133.956L110.151 115.203Z" fill="black" />
      <path d="M135.779 111.047L166.512 113.339L164.812 134.38L135.779 135.226V111.047Z" fill="#7a2829" />
      <path opacity="0.1" d="M135.779 111.047L166.512 113.339L164.812 134.38L135.779 135.226V111.047Z" fill="black" />
      <path d="M145.228 103.664L135.779 111.044L166.512 113.336L171.535 105.783L145.228 103.664Z" fill="#7a2829" />
      <path d="M100.873 107.143L123.944 104.344L135.78 111.047L110.152 115.203L100.873 107.143Z" fill="#7a2829" />
      <path
        ...
        fill="#7a2829"
      />
      <path d="M166.512 113.336V145.575L156.89 147.416L152.211 148.311L141.397 150.381V117.323L166.512 113.336Z" fill="#7a2829" />
      ...
      <path d="M100.873 122.162L110.152 115.203L141.398 117.326L136.798 125.047L100.873 122.162Z" fill="#7a2829" />
      <path opacity="0.1" d="M100.873 122.162L110.152 115.203L141.398 117.326L136.798 125.047L100.873 122.162Z" fill="white" />
      <path d="M166.512 113.336L141.397 117.323L149.572 124.62L176.474 120.122L166.512 113.336Z" fill="#7a2829" />
...
const BioMetricIcon = ({ fill = "#7a2829" }) => (
