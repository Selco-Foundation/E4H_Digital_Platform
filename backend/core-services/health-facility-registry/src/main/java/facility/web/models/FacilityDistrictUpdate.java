...
@NoArgsConstructor
@AllArgsConstructor
public class FacilityDistrictUpdate {
    ...
    @NotBlank
    @Schema(name = "new_district_boundary_code", requiredMode = Schema.RequiredMode.REQUIRED)
    @JsonProperty("new_district_boundary_code")
    private String newDistrictBoundaryCode;

    @NotBlank
    @Schema(name = "new_block_boundary_code", requiredMode = Schema.RequiredMode.REQUIRED,
            description = "Full block boundary code in the target district (blocks differ per district)")
