...
import org.egov.activity.web.models.ActivityAssignmentBulkRequest;
...
public class ActivityAssignmentConsumer {
    ...
    public ActivityAssignmentConsumer(ActivityService service, @Qualifier("objectMapper") ObjectMapper objectMapper) {
