...
public class ProjectTaskRowMapper implements RowMapper<Task> {
    ...
    public Task mapRow(ResultSet resultSet, int i) throws SQLException {
        try {
            AuditDetails auditDetails = buildAuditDetails(resultSet);
            AuditDetails clientAuditDetails = buildClientAuditDetails(resultSet);
            Address address = buildAddress(resultSet);
            Task task = buildTask(resultSet, auditDetails, clientAuditDetails, address);
            
            if (task.getAddress() != null && task.getAddress().getId() == null) {
    ...
    private AuditDetails buildAuditDetails(ResultSet resultSet) throws SQLException {
    ...
    private AuditDetails buildClientAuditDetails(ResultSet resultSet) throws SQLException {
        return AuditDetails.builder()
    ...
    private Task buildTask(ResultSet resultSet, AuditDetails auditDetails, AuditDetails clientAuditDetails, Address address) throws SQLException, JsonProcessingException {
        return Task.builder()
