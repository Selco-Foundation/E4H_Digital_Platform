...
public class UserAnalyticsConstants {
    ...
    /**
     * {@code event_type} published by im-services' KibanaLoginConsumer, which translates the raw
     * Kibana audit log onto the shared topic. These carry {@code application=KIBANA} and no state or
     * role — the accounts are Elasticsearch-native and have no egov user behind them.
     */
     ...
     */
    public static final String VENDOR_SYSTEM_ROLE = "COMPLAINT_RESOLVER";
     ...
     * from the report.
     */
    public static final String SAURA_EMITRA = "SAURA_EMITRA";
    public static final String FIELD_ASSIST = "FIELD_ASSIST";
    public static final String MANAGEMENT_HUB = "MANAGEMENT_HUB";
    ...
    /**
     * Events produced by {@link #VENDOR_SYSTEM_ROLE}, counted inside each state-and-application
     * bucket. A {@code filter} rather than a {@code terms} — only the one role is reported on.
     */
    public static final String AGG_VENDOR_ACTIONS = "vendor_actions";

    /** {@code KIBANA_LOGIN} filter and, nested under it, the per-username terms. */
    public static final String AGG_KIBANA_LOGINS = "kibana_logins";
    public static final String AGG_BY_USER_NAME = "by_user_name";
    ...
    public static final String SHEET_KIBANA_LOGINS = "Kibana Logins";
