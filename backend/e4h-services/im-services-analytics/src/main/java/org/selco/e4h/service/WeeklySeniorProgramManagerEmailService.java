...
public class WeeklySeniorProgramManagerEmailService {
    ...
    private String renderOverview(WeeklyTicketOverview overview) {
        ...
        return "<ul>"
                ...
                + "<li>Carried forward (open): <strong>" + overview.getCarriedForward() + "</strong></li>"
                + "</ul>";
    }
    ...
    private String renderFacilitySummary(WeeklyEscalationAnalytics analytics) {
        return "<p>Facilities with open tickets: <strong>" + analytics.getFacilitiesWithOpenTickets()
                + "</strong> | NF facilities with open tickets: <strong>"
