 ...
 * Monthly solar kWh is capped using state sunshine hours and facility kWp when both are available.
 */
@Slf4j
@Service
...
public class CarbonEmissionCalculator {
    ...
    /**
     * PRD: monthly max solar kWh = kWp × sunshine_hours_per_day × days_in_month.
     * Skips cap when kWp, state, or sunshine reference is missing.
     */
