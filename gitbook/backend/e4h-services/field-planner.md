...
- Service path: [`backend/e4h-services/field-planner`](https://github.com/Selco-Foundation/E4H_Digital_Platform/tree/add-gitbook-docs/backend/e4h-services/field-planner)
