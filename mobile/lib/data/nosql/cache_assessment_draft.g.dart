...
void _cacheAssessmentDraftSerialize(
  ...
  writer.writeString(offsets[5], object.facilityType);
  writer.writeString(offsets[6], object.lastError);
  writer.writeString(offsets[7], object.phase);
  writer.writeString(offsets[8], object.planFacilityId);
  writer.writeString(offsets[9], object.requestJson);
...
CacheAssessmentDraft _cacheAssessmentDraftDeserialize(
  ...
  final object = CacheAssessmentDraft(
    ...
    draftKey: reader.readString(offsets[3]),
    facilityName: reader.readString(offsets[4]),
    facilityType: reader.readString(offsets[5]),
    lastError: reader.readStringOrNull(offsets[6]),
    phase: reader.readString(offsets[7]),
    planFacilityId: reader.readString(offsets[8]),
    requestJson: reader.readString(offsets[9]),
    status: reader.readString(offsets[10]),
    tenantId: reader.readString(offsets[11]),
  );
